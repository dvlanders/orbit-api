...
module.exports = (router) => {
  ...
  router.post("/user/:user_id/:transfer_id/confirmtransfer",payout.confirmTransferPayment);
  ...
  router.post("/user/:user_id/withdrawalcalculation", payout.withdrawalCalculation)
