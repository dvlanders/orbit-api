...
const { authorize, authorizeDashboard, requiredProdDashboard, requiredAdmin, logRequestResponse } = require("../../util/middleware");

module.exports = (router) => {
	router.post("/dashboard/transfer/crypto-to-crypto", authorizeDashboard, requiredProdDashboard, logRequestResponse, transfer.createCryptoToCryptoTransfer);
	router.post("/dashboard/transfer/crypto-to-crypto/developer", authorizeDashboard, requiredProdDashboard, requiredAdmin, logRequestResponse, transfer.createCryptoToCryptoTransfer);
	...
	router.post("/dashboard/transfer/crypto-to-fiat", authorizeDashboard, requiredProdDashboard, logRequestResponse, transfer.createCryptoToFiatTransfer);
	router.post("/dashboard/transfer/crypto-to-fiat/developer", authorizeDashboard, requiredProdDashboard, requiredAdmin, logRequestResponse, transfer.createCryptoToFiatTransfer);
	...
	router.post("/dashboard/transfer/fiat-to-crypto", authorizeDashboard, requiredProdDashboard, logRequestResponse, transfer.createFiatToCryptoTransfer)
