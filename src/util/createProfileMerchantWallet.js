...
// /**
//  * Spins up a new Supabase Auth user with a profile, merchant, and wallet records. Returns the new user's wallet address.
//  */
// exports.createProfileMerchantWallet = async (req, res, next) => {
