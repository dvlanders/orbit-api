...
exports.createExchangeTransfer = async (req, res) => {
	...
	// Log the selected offering if found
	if (selectedOffering) {
		console.log('Selected Offering:', JSON.stringify(selectedOffering, null, 2));
	} else {
		console.log('No offering found with ID:', offeringId);
	}
...
exports.createExchangeTransferTemp = async (req, res) => {
	...
	const selectedOffering = matchedOfferings.find(offering => offering.metadata.id === 'offering_01j8thhe0pf6jaybgd00y7ht40');
